...
{{ Form::model($product, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('products.update', $product->id))) }}
        ...
        <div class="form-group">
	        ...
	        <div class="col-sm-10">
	          {{ Form::select('category_id', Category::lists('name', 'id'), Input::old('category_id'), array('class'=>'form-control')) }}
	        </div>
	    </div>
	    ...
	    <div class="form-group">
	        ...
	        <div class="col-sm-10">
			  {{ Form::select('details[]', Detail::lists('name', 'id'), $product->details->lists('id'), ['class' => 'form-control', 'multiple']) }}
	        </div>
	    </div>
